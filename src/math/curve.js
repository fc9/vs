Object.assign(vs, (function () {
    ...
    var Curve = function (data) {
        ...
        this._eval = new vs.CurveEvaluator(this)
    ...
    Object.assign(Curve.prototype, {
         ...
         * @returns {vs.Curve} A clone of the specified curve
         */
        clone: function () {
            var result = new vs.Curve()
            result.keys = vs.extend(result.keys, this.keys)
