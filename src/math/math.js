...
vs.math = {
     ...
     * @constant
     * @type {Number}
     * @name vs.math.RAD_TO_DEG
     * @description Conversion factor between degrees and radians
     * @example
     * // Convert pi radians to 180 degrees
     * var deg = Math.PI * vs.math.RAD_TO_DEG;
     */
     ...
     * var bytes = vs.math.intToBytes24(0x112233);
     */
    ...
    /**
     * @function
     * @name vs.math.bytesToInt24
     * @description Convert 3 8 bit Numbers into a single unsigned 24 bit Number.
     * @example
     * // Set result1 to 0x112233 from an array of 3 values
     * var result1 = vs.math.bytesToInt24([0x11, 0x22, 0x33]);
     *
     * // Set result2 to 0x112233 from 3 discrete values
     * var result2 = vs.math.bytesToInt24(0x11, 0x22, 0x33);
     ...
     * var result1 = vs.math.bytesToInt32([0x11, 0x22, 0x33, 0x44]);
     *
     * // Set result2 to 0x11223344 from 4 discrete values
     * var result2 = vs.math.bytesToInt32(0x11, 0x22, 0x33, 0x44);
     * @param {Number} r A single byte (0-255)
     * @param {Number} g A single byte (0-255)
     * @param {Number} b A single byte (0-255)
    ...
    lerp: function (a, b, alpha) {
        return a + (b - a) * vs.math.clamp(alpha, 0, 1)
    },

    /**
     * @function
     * @name vs.math.lerpAngle
    ...
    lerpAngle: function (a, b, alpha) {
        ...
        return vs.math.lerp(a, b, vs.math.clamp(alpha, 0, 1))
    },

    /**
     * @function
     * @name vs.math.powerOfTwo
     ...
     */
    random: function (min, max, rounding = null) {
        var diff = max - min,
        number = Math.random() * diff + min
        return rounding !== null ? rounding === "ceil" ? Math.ceil(number) : Math.floor(number) : number
    },

    /**
     * @function
     * @name vs.math.smoothstep
    ...
    /**
     * @function
     * @name vs.math.smootherstep
     * @description An improved version of the vs.math.smoothstep function which has zero
