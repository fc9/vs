Object.assign(vs, (function () {
     ...
     * @description Creates a new identity Matrix3x3 object.
    ...
    Object.assign(Matrix3x3.prototype, {
        /**
         * @function
         * @name vs.Matrix3x3#clone
         * @description Creates a duplicate of the specified matrix.
         * @returns {vs.Matrix3x3} A duplicate matrix.
         * @example
         * var src = new vs.Matrix3x3().translate(10, 20, 30)
         * var dst = src.clone()
         * console.log("The two matrices are " + (src.equals(dst) ? "equal" : "different"))
         */
        clone: function () {
            return new vs.Matrix3x3().copy(this)
        },

        /**
         * @function
         * @name vs.Matrix3x3#copy
         * @description Copies the contents of a source 3x3 matrix to a destination 3x3 matrix.
         * @param {vs.Matrix3x3} rhs A 3x3 matrix to be copied.
         * @returns {vs.Matrix3x3} Self for chaining
         * @example
         * var src = new vs.Matrix3x3().translate(10, 20, 30)
         * var dst = new vs.Matrix3x3()
         * dst.copy(src)
         * console.log("The two matrices are " + (src.equals(dst) ? "equal" : "different"))
         */
        copy: function (rhs) {
        ...
        /**
         * @function
         * @name vs.Matrix3x3#equals
         * @param {vs.Matrix3x3} rhs The other matrix.
         * @description Reports whether two matrices are equal.
         * @returns {Boolean} true if the matrices are equal and false otherwise.
         * @example
         * var a = new vs.Matrix3x3().translate(10, 20, 30)
         * var b = new vs.Matrix3x3()
