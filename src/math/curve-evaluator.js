    ...
    Object.assign(CurveEvaluator.prototype, {
        ...
        evaluate: function (time, forceReset) {
            ...
            if (type === vs.CURVE_STEP) {
                ...
                if (type === vs.CURVE_LINEAR) {
                    // linear
                    result = vs.math.lerp(this._p0, this._p1, t)
                } else if (type === vs.CURVE_SMOOTHSTEP) {
                    // smoothstep
                    result = vs.math.lerp(this._p0, this._p1, t * t * (3 - 2 * t))
                } else {
                    // curve
        ...
        _isHermite: function () {
            return this._curve.type === vs.CURVE_CATMULL ||
                this._curve.type === vs.CURVE_CARDINAL ||
                this._curve.type === vs.CURVE_SPLINE;
        },
        ...
        _calcTangents: function (keys, index) {
            ...
            if (this._curve.type === vs.CURVE_SPLINE) {
                ...
                var tension = (this._curve.type === vs.CURVE_CATMULL) ? 0.5 : this._curve.tension
