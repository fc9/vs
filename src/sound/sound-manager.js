Object.assign(vs, function () {
     ...
     * @private
     * @function
     * @name vs.SoundManager.hasAudioContext
     ...
     * @property {Number} volume Global volume for the manager. All {@link vs.SoundInstance}s will scale their volume with this volume. Valid between [0, 1].
     */
    var SoundManager = function (options) {
        ...
        this.listener = new vs.Listener(this)

        this._volume = 1
        this.suspended = false
    };
    SoundManager.prototype = Object.create(vs.EventHandler.prototype)
    ...
    Object.assign(SoundManager.prototype, {
         ...
         * @private
         * @function
         * @name vs.SoundManager#playSound
         * @description Create a new vs.Channel and begin playback of the sound.
         * @param {vs.Sound} sound The Sound object to play.
         ...
         * @returns {vs.Channel} The channel playing the sound.
         */
        playSound: function (sound, options) {
            options = options || {}
            var channel = null
            if (vs.Channel) {
                channel = new vs.Channel(this, sound, options)
                channel.play()
            }
            return channel
        },
         ...
         * @private
         * @function
         * @name vs.SoundManager#playSound3d
         * @description Create a new vs.Channel3d and begin playback of the sound at the position specified
         * @param {vs.Sound} sound The Sound object to play.
         * @param {vs.Vec3} position The position of the sound in 3D space.
         * @param {Object} options Optional options object.
         * @param {Number} [options.volume] The volume to playback at, between 0 and 1.
         * @param {Boolean} [options.loop] Whether to loop the sound when it reaches the end.
         * @returns {vs.Channel3d} The 3D channel playing the sound.
         */
        playSound3d: function (sound, position, options) {
            options = options || {}
            var channel = null
            if (vs.Channel3d) {
                channel = new vs.Channel3d(this, sound, options)
