Object.assign(vs, function () {
    ...
    if (vs.SoundManager.hasAudioContext()) {
        /**
         * @constructor
         * @name vs.SoundInstance
         * @extends vs.EventHandler
         * @classdesc A vs.SoundInstance plays a {@link vs.Sound}
         ...
         * @property {vs.Sound} sound The sound resource that the instance will play.
         */
        SoundInstance = function (manager, sound, options) {
            vs.EventHandler.call(this);

            options = options || {};

            this._volume = options.volume !== undefined ? vs.math.clamp(Number(options.volume) || 0, 0, 1) : 1;
        ...
        SoundInstance.prototype = Object.create(vs.EventHandler.prototype);
        ...
        Object.assign(SoundInstance.prototype, {
             ...
             * @function
             * @private
             * @name vs.SoundInstance#_initializeNodes
            ...
            /**
             * @function
             * @name vs.SoundInstance#setExternalNodes
            ...
            /**
             * @function
             * @name vs.SoundInstance#clearExternalNodes
             * @description Clears any external nodes set by {@link vs.SoundInstance#setExternalNodes}.
             */
            ...
            /**
             * @function
             * @name vs.SoundInstance#getExternalNodes
             * @description Gets any external nodes set by {@link vs.SoundInstance#setExternalNodes}.
             * @returns {AudioNode[]} Returns an array that contains the two nodes set by {@link vs.SoundInstance#setExternalNodes}.
             */
             ...
             * @private
             * @function
             * @name vs.SoundInstance#_updateCurrentTime
             ...
             * @private
             * @function
             * @name vs.SoundInstance#_onManagerDestroy
        ...
        Object.defineProperty(SoundInstance.prototype, 'volume', {
            ...
            set: function (volume) {
                volume = vs.math.clamp(volume, 0, 1);
                this._volume = volume;
                if (this.gain) {
    ...
    } else if (vs.SoundManager.hasAudio()) {
    ...
    Object.assign(SoundInstance.prototype, {
         ...
         * @private
         * @function
         * @name vs.SoundInstance#_onManagerVolumeChange
         ...
         * @private
         * @function
         * @name vs.SoundInstance#_onManagerSuspend
         ...
         * @private
         * @function
         * @name vs.SoundInstance#_onManagerResume
