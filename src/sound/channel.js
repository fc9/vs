Object.assign(vs, function () {
    ...
    if (vs.SoundManager.hasAudioContext()) {
         ...
         * @constructor
         * @name vs.Channel
         * @classdesc A channel is created when the vs.SoundManager begins playback of a vs.Sound. Usually created internally by
         * vs.SoundManager#playSound or vs.SoundManager#playSound3d. Developers usually won't have to create Channels manually.
         * @param  SoundManager} manager The SoundManager instance
         * @param {vs.Sound} sound The sound to playback
    ...
    Object.assign(Channel.prototype, {
         ...
         * @private
         * @function
         * @name vs.Channel#onManagerVolumeChange
         ...
         * @private
         * @function
         * @name vs.Channel#onManagerSuspend
         ...
         * @private
         * @function
         * @name vs.Channel#onManagerResume
