Object.assign(vs, function () {
    ...
    if (vs.SoundManager.hasAudioContext()) {
        Channel3d = function (manager, sound, options) {
            vs.Channel.call(this, manager, sound, options)

            this.position = new vs.Vector3d()
            this.velocity = new vs.Vector3d()

            var context = manager.context
            this.panner = context.createPanner()
        }
        Channel3d.prototype = Object.create(vs.Channel.prototype)
        ...
        Object.assign(Channel3d.prototype, {
             ...
             * @private
             * @function
             * @name vs.Channel3d#_createSource
        ...
        Channel3d = function (manager, sound) {
            vs.Channel.call(this, manager, sound)
            ...
            this.distanceModel = vs.DISTANCE_INVERSE
        }
        Channel3d.prototype = Object.create(vs.Channel.prototype)
        Channel3d.prototype.constructor = Channel3d
