Object.assign(vs, (function () {
    ...
    Object.assign(EventHandler.prototype, {
        /**
         * @function
         * @name vs.EventHandler#on
         * @description Attach an event handler to an event
         * @param {String} name Name of the event to bind the callback to
         * @param {vs.callbacks.HandleEvent} callback Function that is called when event is fired. Note the callback is limited to 8 arguments.
         * @param {Object} [scope] Object to use as 'this' when the event is fired, defaults to current this
         * @returns {vs.EventHandler} Self for chaining.
         * @example
        ...
        /**
         * @function
         * @name vs.EventHandler#off
         * @description Detach an event handler from an event. If callback is not provided then all callbacks are unbound from the event,
         * if scope is not provided then all events with the callback will be unbound.
         * @param {String} [name] Name of the event to unbind
         * @param {vs.callbacks.HandleEvent} [callback] Function to be unbound.
