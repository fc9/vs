Object.assign(vs, (function () {
     ...
     * @constructor
     * @name vs.IndexedList
     * @classdesc A ordered list-type data structure that can provide item look
     * up by key, but also return return a list.
     */
    ...
    Object.assign(IndexedList.prototype, {
         ...
         * @private
         * @function
         * @name vs.IndexedList#remove
         * @description Remove the item indexed by key from the list
         * @param {String} key The key at which to remove the item
         * @returns {Boolean} Returns true if the key exists and an item was
         * removed, returns false if no item was removed
         */
        remove: function (key) {
            var location = this._index[key]
            if (location !== undefined) {
