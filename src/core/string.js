...
vs.string = function () {
    ...
    return {
         ...
         * @constant
         * @type {String}
         * @name vs.string.ASCII_LOWERCASE
         ...
         * @constant
         * @type {String}
         * @name vs.string.ASCII_UPPERCASE
         ...
         * @example
         * var s = vs.string.format("Hello {0}", "world")
         * console.log(s); // Prints "Hello world"
         */
        format: function (s) {
            var i = 0,
                regexp,
                args = vs.makeArray(arguments)
