Object.assign(vs, (function () {
    ...
    Object.assign(Color.prototype, {
         ...
         * @returns {vs.Color} A duplicate color object
         */
        clone: function () {
            return new vs.Color(this.r, this.g, this.b, this.a)
        },
         ...
         * @param {vs.Color} rhs A color to copy to the specified color.
         * @returns {vs.Color} Self for chaining
         * @example
         * var src = new vs.Color(1, 0, 0, 1)
         * var dst = new vs.Color()
         *
         * dst.copy(src)
         *
         ...
         * @param {vs.Color} lhs The color to interpolate from
         * @param {vs.Color} rhs The color to interpolate to.
         * @param {Number} alpha The value controlling the point of interpolation. Between 0 and 1, the linear interpolant
         * will occur on a straight line between lhs and rhs. Outside of this range, the linear interpolant will occur on
         * a ray extrapolated from this line.
         * @returns {vs.Color} Self for chaining.
         * @example
         * var a = new vs.Color(0, 0, 0)
         * var b = new vs.Color(1, 1, 0.5)
         * var r = new vs.Color()
         *
        ...
        fromString: function (hex) {
            ...
            var bytes
            if (hex.length > 7) {
                bytes = vs.math.intToBytes32(i)
            } else {
                bytes = vs.math.intToBytes24(i)
                bytes[3] = 255
            }
